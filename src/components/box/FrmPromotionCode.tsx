...
const FrmPromotionCodeMint:FC = () =>{
    ...
    return (
        <GoogleReCaptchaProvider  reCaptchaKey="6Lfj8agiAAAAAPYgBTzg1YqeTngZsF4AhTLvbwun">
            <div className="flex flex-row mt-14 px-2 items-center justify-center border border-[#fca50068] rounded-[42px] shadow-[inset_0_0_7px_rgba(251,163,1,0.23)] relative">
                ...
                <button 
                    disabled={isPending}
                    className='w-[120px] py-2 h-12 leading-1 rounded-3xl font-poppins font-medium text-sm bg-[#ffa42c22] text-white absolute right-2'>
                    { isPending ? "Checking..." :"Apply" }
                </button>}
