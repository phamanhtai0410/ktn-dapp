        ...
        <GoogleReCaptchaProvider  reCaptchaKey="6Lfj8agiAAAAAPYgBTzg1YqeTngZsF4AhTLvbwun">
            {/* <div className="flex flex-row mt-14 px-2 items-center justify-center border border-[#fca50068] rounded-[42px] shadow-[inset_0_0_7px_rgba(251,163,1,0.23)]">
                ...
                <input
                    ...
                    className="placeholder-[#ffffff47] w-[380px] mx-2 bg-transparent leading-4 font-jost font-bold text-xl text-[#fca500b3] rounded-[5px] my-3 py-1 focus:outline-none text-left px-2 shadow-[inset_1.5px_2.598px_5px_0px_rgba(0,0,0,0.1)] bg-opacity-60 brightness-110" 
                />
                ...
                <button 
                    ...
                    disabled={isPending}
                    className='w-[120px] py-2 h-12 leading-1 rounded-3xl font-poppins font-medium text-sm bg-[#FFA52C] text-white absolute right-16'>
                    { isPending ? "Checking..." :"Apply" }  
                </button> 
                :
                <button 
                    disabled={isPending}
                    className='w-[120px] py-2 h-12 leading-1 rounded-3xl font-poppins font-medium text-sm bg-[#ffa42c22] text-white absolute right-16'>
                    { isPending ? "Checking..." :"Apply" }
                </button>}
...
export default FrmPromotionCodeBox;