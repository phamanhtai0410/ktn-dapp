...
const DetailNFTSale = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row gap-x-[50px] mt-[38px] pt-[32px] border-t-[0.5px] border-[#C7C7C7]">
            <div className="flex flex-col">
                <div className="flex items-center uppercase justify-center w-full md:w-[214px] h-[41px] px-[22px] py-[7px] text-[#F9C306] text-[20px] font-extrabold bg-[#000000] rounded-[12px]">
                    Whitelist Sale
                </div>
                <div className="mt-[13px] uppercase text-[20px]">
