            ...
            <div className="relative flex h-[440px] w-full bg-no-repeat lg:bg-[length:100%_100%] bg-cover bg-[url('../../assets/images/mintpage/layout_bg_footer.jpg')]">
                <div className='flex flex-col md:absolute left-[200px] top-[91px]'>
                    <div className='flex flex-col max-w-[735px]'>
                        ...
                        <p className='text-[#D0D4EA] text-[20px]'>with focus on free2play and play2earn to attract web2 gamers. </p>
                    </div>
                    <div className='flex max-w-[530px] mt-[28px] mb-[39px]'>
                        <p className='text-[#D0D4EA] text-[16px]'>Check for Katana Inu Ecosystem for Renting, Staking, our Marketplace or for purchasing our $Kata Token:</p>
                    </div>
                    <div className='flex'>
                        <div
                            className='mr-[24px] flex items-center justify-between h-[56px] bg-[#F9C306] pl-[12px] pr-[8px] rounded-[100px]'
                        >
                        ...
                        <div
                            className='mr-[24px] flex items-center justify-between h-[56px] bg-[#F9C306] pl-[12px] pr-[8px] rounded-[100px]'
                        >
                            <span className='mr-[10px] text-[16px]'>Go to Kainu.io Marketplace    </span>
                            <div className='flex items-center justify-center bg-[#15103C] rounded-full w-[40px] h-[40px]'>
                                <img src={arrow_up_right_small} alt="arrow_up_right_small" className='w-auto' />
                            </div>
                        </div>
